...
class History:
    ...
    def add_mentor_facet_influence_strings(cat):
        ...
        facet_influence_text = {
            ...
            "aggression_raise": [
                "be ready for a fight", "start a fight", "defend their beliefs", "use fangs over words",
                "resort to violence"
            ],
            "aggression_lower": [
                "be slow to anger", "avoid a fight", "use words over fangs", "try to avoid violence"
            ],
            "stability_raise": [
    ...
    def add_mentor_skill_influence_strings(cat):
        ...
        skill_influence_text = {
            ...
            SkillPath.STAR: ["connecting to StarPack"],
