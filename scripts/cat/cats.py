...
class Cat:
        ...
        if self.status == 'leader':
            if game.clan.leader_lives > 0:
                ...
                if game.clan.instructor.df is False:
                    text = (
                        "They've lost their last life and have travelled to StarPack."
                    )
                else:
    ...
    def thoughts(self):
        ...
        # it appears as for now, pets and loners can only think about outsider cats
    ...
    def get_save_dict(self, faded=False):
        if faded:
            ...
            return {
                ...
                "points_genes": self.pelt.points_genes,
