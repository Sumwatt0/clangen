...
class ChangeCatName(UIWindow):
    ...
    def __init__(self, cat):
        ...
        self.toggle_spec_block_off = UIImageButton(
            ...
            "",
            object_id="#checked_checkbox",
            tool_tip_text="Re-enable the wolf's special suffix",
            manager=MANAGER,
            container=self,
        )
...
class PronounCreation(UIWindow):
    ...
    def __init__(self, cat, resourcepath):
        ...
        self.boxes = {}
        self.checkbox_label = {}
        Demo_frame = resourcepath + "images/demo_frame.png"
        self.back_button = UIImageButton(
...
class KillCat(UIWindow):
    ...
    def __init__(self, cat):
        ...
        if self.the_cat.status == "leader":
            ...
            self.initial = process_text(
                "{VERB/m_c/were/was} killed by something unknowable to even StarPack",
                cat_dict,
            )
            self.all_lives_check.hide()
