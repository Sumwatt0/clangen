...
class ProfileScreen(Screens):
    ...
    def generate_column2(self, the_cat):
        ...
        if (
            ...
            and the_cat.status not in ["pet", "loner", "rogue", "former Packwolf"]
        ):
    ...
    def get_backstory_text(self):
        ...
        if (
            self.the_cat.status in ["pet", "loner", "rogue", "former Packwolf"]
        ...
        if not self.the_cat.dead and self.the_cat.status not in [
            ...
            if beginning:
                if beginning["clan_born"]:
                    ...
                    text += (
                        " {PRONOUN/m_c/subject/CAP} joined the Pack on Moon "
                        + str(beginning["moon"])
                        + " at the age of "
                        + str(beginning["age"])
                        + " Moons."
