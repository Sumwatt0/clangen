...
class ChooseMateScreen(Screens):
    list_frame = pygame.transform.scale(
        image_cache.load_image(resourcepath + "images/choosing_frame.png").convert_alpha(),
    ...
    def screen_switches(self):
        ...
        self.info = pygame_gui.elements.UITextBox(
            "If a wolf has mates, then they will be loyal and only have puppies with their mates"
            " (unless affairs are toggled on.) Potential mates are listed below! The lines "
            "connecting the two wolves may give a hint on their compatibility with one another "
        ...
        self.the_cat_frame = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/choosing_cat1_frame_mate.png"
                ).convert_alpha(),
                (532, 394),
            ),
        )
        self.mate_frame = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/choosing_cat2_frame_mate.png"
                ).convert_alpha(),
                (532, 394),
            ),
        )
    ...
    def update_current_cat_info(self, reset_selected_cat=True):
        ...
        info = (
            ...
            + " moons\n"
            + self.the_cat.status.replace("cat", "wolf")
            + "\n"
    ...
    def update_selected_cat(self):
        ...
        if self.selected_cat.ID in self.the_cat.mate:
            self.selected_cat_elements["center_heart"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/heart_mates.png"
                    ).convert_alpha(),
                    (400, 156),
                ),
            )
            ...
            self.selected_cat_elements["center_heart"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/heart_breakup.png"
                    ).convert_alpha(),
                    (400, 156),
                ),
            )
            ...
            self.selected_cat_elements["center_heart"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/heart_maybe.png"
                    ).convert_alpha(),
                    (400, 156),
                ),
            )
        ...
        info = (
            ...
            + " moons\n"
            + self.selected_cat.status.replace("cat", "wolf")
            + "\n"
        ...
        if (
            ...
            self.selected_cat_elements["no kit warning"] = (
                pygame_gui.elements.UITextBox(
                    f"<font pixel_size={int(22 / 1400 * screen_y)}> This pair can't have biological puppies </font>",
    ...
    def draw_compatible_line_affection(self):
        ...
        self.selected_cat_elements["compat_line"] = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/line_neutral.png"
                ).convert_alpha(),
                (400, 156),
            ),
        )
        if get_personality_compatibility(self.the_cat, self.selected_cat) is True:
            self.selected_cat_elements["compat_line"].set_image(
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/line_compatible.png"
                    ).convert_alpha(),
                    (400, 156),
                )
            )
            ...
            self.selected_cat_elements["compat_line"].set_image(
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/line_incompatible.png"
                    ).convert_alpha(),
                    (400, 156),
                )
            )
        ...
        for i in range(0, heart_number):
            self.selected_cat_elements["heart1" + str(i)] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/heart_big.png"
                    ).convert_alpha(),
                    (44, 40),
                ),
            )
