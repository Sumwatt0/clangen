...
class EventsScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.heading = pygame_gui.elements.UITextBox(
            "Timeskip to progress your Pack's life.",
        ...
        self.events_frame = pygame_gui.elements.UIImage(
            scale(pygame.Rect((412, 532), (1068, 740))),
                    ...
                    if game.settings["dark mode"]:
                        self.display_events_elements["shading" + str(i)] = (
                            pygame_gui.elements.UIImage(
                                ...
                                image_cache.load_image(
                                    resourcepath + "images/shading_dark.png"
                                ),
                                container=self.event_container,
                                manager=MANAGER,
                            )
                        ...
                        self.display_events_elements["shading" + str(i)] = (
                            pygame_gui.elements.UIImage(
                                ...
                                image_cache.load_image(resourcepath + "images/shading.png"),
                                container=self.event_container,
                                manager=MANAGER,
                            )
                        )
