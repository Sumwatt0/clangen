...
class ChooseMentorScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.mentor_frame = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/choosing_cat1_frame_ment.png"
                ).convert_alpha(),
                (562, 394),
            ),
            manager=MANAGER,
        ...
        self.app_frame = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/choosing_cat2_frame_ment.png"
                ).convert_alpha(),
                (562, 394),
            ),
            manager=MANAGER,
        ...
        self.mentor_icon = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(resourcepath + "images/mentor.png").convert_alpha(),
                (343, 228),
            ),
            manager=MANAGER,
        )
    ...
    def update_apprentice(self):
        ...
        info = (
            str(self.the_cat.status).replace("cat", "wolf")
            + "\n"
    ...
    def update_selected_cat(self):
        ...
        if self.selected_mentor:
            ...
            info = (
                str(self.selected_mentor.status).replace("cat", "wolf")
                + "\n"
