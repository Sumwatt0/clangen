...
class ClearingScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.help_button = UIImageButton(
            ...
            manager=MANAGER,
            tool_tip_text="Your Pack will catch some amount of prey over each timeskip, but successful hunting patrols are the most "
            ...
            "Wolves under 3 moons with a parent(queen) taking care of them, don't need food. "
            "<br><br>"
            "Feeding the Pack is very important, therefore cats will be fed before any changes to rank. "
            "Hover your mouse over the pile to see the current amount and the needed amount of prey of your Pack! ",
        )
        ...
        self.cat_bg = pygame_gui.elements.UIImage(
            ...
            pygame.image.load(resourcepath + "images/sick_hurt_bg.png").convert_alpha(),
            manager=MANAGER,
        )
        self.cat_bg.disable()
