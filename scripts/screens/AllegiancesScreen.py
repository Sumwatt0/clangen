...
class AllegiancesScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.heading = pygame_gui.elements.UITextBox(
            f"{game.clan.name}Pack Allegiances",
    ...
    def get_allegiances_text(self):
        ...
        if living_meds:
            ...
            if len(living_meds) == 1:
                _box[0] = "<b><u>MEDICINE WOLF</u></b>"
            else:
                _box[0] = "<b><u>MEDICINE WOLVES</u></b>"
...
class MedDenScreen(Screens):
    ...
    def screen_switches(self):
        ...
        if self.meds:
            ...
            meds_cover = f"You have no medicine wolves, your clan will be at higher risk of death and sickness."
