...
class FamilyTreeScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.relation_backdrop = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/familytree_relationbackdrop.png"
                ).convert_alpha(),
                (841, 342),
            ),
            manager=MANAGER,
        ...
        self.root_cat_frame = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/familytree_bigcatbox.png"
                ).convert_alpha(),
                (452, 340),
            ),
            manager=MANAGER,
        ...
        self.center_cat_frame = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    resourcepath + "images/familytree_smallcatbox.png"
                ).convert_alpha(),
                (160, 180),
            ),
            manager=MANAGER,
    ...
    def update_tab(self):
        ...
        if self.current_group_name == "grandparents":
            self.tabs["grandparents_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/grandparents_tab.png"
                    ).convert_alpha(),
                    (256, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["parents_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/parents_tab.png"
                    ).convert_alpha(),
                    (174, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["parents_siblings_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/parentsibling_tab.png"
                    ).convert_alpha(),
                    (296, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["cousins_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/cousins_tab.png"
                    ).convert_alpha(),
                    (166, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["siblings_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/siblings_tab.png"
                    ).convert_alpha(),
                    (164, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["siblings_mates_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/siblingsmate_tab.png"
                    ).convert_alpha(),
                    (274, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["siblings_kits_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/siblingkits_tab.png"
                    ).convert_alpha(),
                    (250, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["mates_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/mates_tab.png"
                    ).convert_alpha(),
                    (150, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["kits_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/kits_tab.png"
                    ).convert_alpha(),
                    (114, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["kits_mates_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/kitsmate_tab.png"
                    ).convert_alpha(),
                    (224, 60),
                ),
                manager=MANAGER,
            ...
            self.tabs["grandkits_tab"] = pygame_gui.elements.UIImage(
                ...
                pygame.transform.scale(
                    image_cache.load_image(
                        resourcepath + "images/grandkits_tab.png"
                    ).convert_alpha(),
                    (200, 60),
                ),
                manager=MANAGER,
