...
class ClanSettingsScreen(Screens):
    ...
    def open_general_settings(self):
        ...
        self.checkboxes_text["instr"] = pygame_gui.elements.UITextBox(
            "Change the general Pack-specific settings",
    ...
    def open_roles_settings(self):
        ...
        self.checkboxes_text["instr"] = pygame_gui.elements.UITextBox(
            "Change Pack-specific settings regarding wolf roles",
            scale(pygame.Rect((200, 370), (1200, 100))),
            object_id=get_text_box_theme("#text_box_30_horizcenter"),
            manager=MANAGER,
        )
    ...
    def open_relation_settings(self):
        ...
        self.checkboxes_text["instr"] = pygame_gui.elements.UITextBox(
            "Change Pack-specific settings regarding wolf relationships",
            scale(pygame.Rect((200, 370), (1200, 100))),
            object_id=get_text_box_theme("#text_box_30_horizcenter"),
            manager=MANAGER,
        )
    ...
    def open_clan_stats(self):
        ...
        text = (
            f"Living Pack Wolves: {living_cats}\n"
