    ...
    def screen_switches(self):
        ...
        self.selected_frame_1 = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(resourcepath + "images/mediator_selected_frame.png"),
                (400, 700),
            ),
        )
        ...
        self.cat_bg = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                pygame.image.load(
                    resourcepath + "images/mediation_selection_bg.png"
                ).convert_alpha(),
                (1400, 300),
            ),
        )
            ...
            for cat in chunked_cats[self.page - 1]:
                if game.clan.clan_settings["show fav"] and cat.favourite:
                    _temp = pygame.transform.scale(
                        pygame.image.load(
                            resourcepath + "images/fav_marker.png"
                        ).convert_alpha(),
                        (100, 100),
                    )
